...
#     return CoAtNet((224, 224), 3, depths, channels, drop_path_rate=0.2, num_classes=1000)


# def coatnet_1():
#     depths = [2, 6, 14, 2]
#     channels = [64, 96, 192, 384, 768]
#     return CoAtNet((224, 224), 3, depths, channels, drop_path_rate=0.3, num_classes=1000)
